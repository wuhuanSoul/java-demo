 ...
 * generated in the com.systec.test package. 
...
public class ObjectFactory {
    ...
    private final static QName _HelloWorld_QNAME = new QName("http://main.systec.com/", "helloWorld");
    private final static QName _HelloWorldResponse_QNAME = new QName("http://main.systec.com/", "helloWorldResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.systec.test
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://main.systec.com/", name = "helloWorld")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://main.systec.com/", name = "helloWorldResponse")
